...
public class CadastroDAO {
	...
	public List<Cadastro> getCadastros(int cod_projeto){
		...
		try {
			...
			while (rset.next()) {
				...
				cadastro.setCod_empregado(rset.getInt("cod_empregado"));
				cadastro.setCod_projeto(rset.getInt("cod_projeto"));
				cadastro.setId_cargo(rset.getInt("id_cargo"));
